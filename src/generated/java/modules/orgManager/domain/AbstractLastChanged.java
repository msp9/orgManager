...
public abstract class AbstractLastChanged extends AbstractPersistentBean {
	...
	/** @hidden */
	public static final String lastChangedPropertyName = "lastChanged";
	...
	public static AbstractLastChanged newInstance() {
		try {
	...
	/**
	 * {@link #lastChanged} mutator.
	 * @param lastChanged	The new value.
	 **/
	@XmlElement
	@XmlSchemaType(name = "dateTime")
	@XmlJavaTypeAdapter(DateTimeMapper.class)
	public void setLastChanged(DateTime lastChanged) {
		preset(lastChangedPropertyName, lastChanged);
